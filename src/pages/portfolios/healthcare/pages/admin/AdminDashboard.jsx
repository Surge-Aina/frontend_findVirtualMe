...
export default function AdminDashboard() {
  ...
  const handleTabSwitch = (newTab) => {
    ...
    if (hasUnsavedChanges) {
      const userChoice = window.confirm(
        'You have unsaved changes.\n\nClick "OK" to save and switch tabs, or "Cancel" to discard changes and switch.'
      );
  ...
  // Helper to update userData and mark as changed
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center min-h-20 h-auto">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button onClick={handleBackNavigation} className="text-gray-600 hover:text-gray-900 p-2">
                <FaArrowLeft />
              </button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              {activeTab === 'practice' && (
                <div className="space-y-6">
                  ...
                  {/* Statistics Section with Toggles */}
              ...
              {activeTab === 'services' && (
                <Suspense fallback={<div className="animate-pulse">Loading...</div>}>
                  <ServicesEditor 
                    ...
                    onUpdate={(services) => {
                      setUserData(prev => ({ ...prev, services }));
                      setHasUnsavedChanges(true);
                    }}
                  />
                </Suspense>
              ...
              {activeTab === 'blog' && (
                <Suspense fallback={<div className="animate-pulse">Loading...</div>}>
                  <BlogEditor 
                    ...
                    onUpdate={(blogPosts) => {
                      setUserData(prev => ({ ...prev, blogPosts }));
                      setHasUnsavedChanges(true);
                    }}
                  />
                </Suspense>
